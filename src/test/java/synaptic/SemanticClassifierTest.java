...
import eu.fbk.ict.fm.nlp.classification.sa.SemanticClassify;
import eu.fbk.ict.fm.nlp.classification.sa.SemanticLearn;
...
public class SemanticClassifierTest {
	...
	public void learnTest() {
		...
		File model = new File("src/test/resources/dataset.tsv.sa.model");
		if (model.exists())
			model.delete();
