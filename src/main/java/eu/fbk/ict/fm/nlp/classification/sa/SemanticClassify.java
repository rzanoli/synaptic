package eu.fbk.ict.fm.nlp.classification.sa;
...
public class SemanticClassify extends AbstractClassify {
	 ...
	 */
	public SemanticClassify(String modelFileName) throws Exception {
	...
	public static void main(String[] args) {
		...
		try {
			...
			SemanticClassify semanticClassify = new SemanticClassify(modelFileName);
			...
			formatter.printHelp("SemanticClassify", options);
